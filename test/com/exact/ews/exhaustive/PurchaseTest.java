 ...
 * Time: 09:02:40
 */
public class PurchaseTest extends BaseTestCase
{
  public PurchaseTest(final String name) {
    super(name);
  }
  ...
  public void testByTrack1() {
    final Request request = getRequestByTrack1(TransactionType.Purchase);
    request.setAmount(10.0f);
    assertTrue(request.isValid());
  ...
  public void testByTrack2() {
    final Request request = getRequestByTrack2(TransactionType.Purchase);
    request.setAmount(10.0f);
    assertTrue(request.isValid());
