 ...
 * Time: 17:37:26
 */
public class OnlineDebitRefundTest extends BaseTestCase
{
  public OnlineDebitRefundTest(final String name) {
    super(name);
  }

  public void testMandatory() {
    final Request request = new Request(TransactionType.IDebitRefund);
