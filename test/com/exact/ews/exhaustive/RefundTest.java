...
{
  public RefundTest(final String name) {
    super(name);
  }
  ...
  public void testByCreditCard() {
    final Request request = getRequestByCCNumber(TransactionType.Refund);
    request.setAmount(10.0f);
    assertTrue(request.isValid());
  ...
  public void testByTrack1() {
    final Request request = getRequestByTrack1(TransactionType.Refund);
    request.setAmount(10.0f);
    assertTrue(request.isValid());
  ...
  public void testByTrack2() {
    final Request request = getRequestByTrack2(TransactionType.Refund);
    request.setAmount(10.0f);
    assertTrue(request.isValid());
