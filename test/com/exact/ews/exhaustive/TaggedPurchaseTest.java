 ...
 * Time: 15:58:28
 */
public class TaggedPurchaseTest extends BaseTestCase
{
  private Response r = null;

  public TaggedPurchaseTest(final String name) {
    super(name);
  }
  ...
  public void testMandatory() {
    final Request request = new Request(TransactionType.TaggedPurchase);
  ...
  public void testJsonWorks() {
    final Request request = getCredentialledRequest(TransactionType.TaggedPurchase);
  ...
  public void testPermittedAfterRecurringSeedPreAuth() {
    final Response r = doRecurringSeedPreAuth();
