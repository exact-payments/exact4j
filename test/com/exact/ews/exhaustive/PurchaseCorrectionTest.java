 ...
 * Time: 14:52:47
 */
public class PurchaseCorrectionTest extends BaseTestCase
{
  public PurchaseCorrectionTest(String name)
  {
    super(name);
  }

  public void testMandatory() {
    final Request request = new Request(TransactionType.PurchaseCorrection);
  ...
  public void testByCreditCard() {
    final Request request = getRequestByCCNumber(TransactionType.PurchaseCorrection);
  ...
  public void testByTrack1() {
    final Request request = getRequestByTrack1(TransactionType.PurchaseCorrection);
    request.setExactId(TestUtils.MonerisExactID);
    request.setPassword(TestUtils.MonerisPassword);
    request.setAmount(10.0f);
    request.setAuthorizationNum("1234");
  ...
  public void testByTrack2() {
    final Request request = getRequestByTrack2(TransactionType.PurchaseCorrection);
    request.setExactId(TestUtils.MonerisExactID);
    request.setPassword(TestUtils.MonerisPassword);
    request.setAmount(10.0f);
    request.setAuthorizationNum("1234");
