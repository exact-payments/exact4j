 ...
 * Time: 09:42:56
 */
public class PreAuthOnlyTest extends BaseTestCase
{
  public PreAuthOnlyTest(final String name) {
    super(name);
  }

  public void testMandatory() {
    final Request request = new Request(TransactionType.PreAuthOnly);
  ...
  public void testByCreditCard() {
    final Request request = getRequestByCCNumber(TransactionType.PreAuthOnly);
    request.setAmount(10.0f);
    assertTrue(request.isValid());
  ...
  public void testByTrack1() {
    final Request request = getRequestByTrack1(TransactionType.PreAuthOnly);
    request.setAmount(10.0f);
    assertTrue(request.isValid());
  ...
  public void testByTrack2() {
    final Request request = getRequestByTrack2(TransactionType.PreAuthOnly);
    request.setAmount(10.0f);
    assertTrue(request.isValid());
