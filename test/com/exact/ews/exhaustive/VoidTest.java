 ...
 * Time: 09:38:44
 */
public class VoidTest extends BaseTestCase
{
  public VoidTest(final String name) {
    super(name);
  }

  public void testMandatory() {
    final Request request = new Request(TransactionType.Void);
  ...
  public void testByCreditCard() {
    final Request request = getRequestByCCNumber(TransactionType.Void);
    request.setAmount(10.0f);
    request.setAuthorizationNum(doPurchase().getRequest().getAuthorizationNum());
    assertTrue(request.isValid());
  ...
  public void testByTrack1() {
    final Request request = getRequestByTrack1(TransactionType.Void);
    request.setAmount(10.0f);
    request.setAuthorizationNum(doPurchase().getRequest().getAuthorizationNum());
    assertTrue(request.isValid());
  ...
  public void testByTrack2() {
    final Request request = getRequestByTrack2(TransactionType.Void);
    request.setAmount(10.0f);
    request.setAuthorizationNum(doPurchase().getRequest().getAuthorizationNum());
    assertTrue(request.isValid());
